...
// node_modules/.pnpm/reveal.js@5.0.4/node_modules/reveal.js/dist/reveal.esm.js
var e = (e2, t2) => {
  for (let i2 in t2)
    e2[i2] = t2[i2];
  return e2;
...
var v = ".slides section";
var m = ".slides>section";
var f = ".slides>section.present>section";
var y = /registerPlugin|registerKeyboardShortcut|addKeyBinding|addEventListener|showPreview/;
var b = /fade-(down|up|right|left|out|in-then-out|in-then-semi-out)|semi-fade-out|current-visible|shrink|grow/;
var w = class {
  constructor(e2) {
    this.Reveal = e2;
  }
...
var A = class {
  ...
  getContrastClass(e2) {
    ...
    if (i2) {
      const e3 = S(i2);
      if (e3 && 0 !== e3.a)
        return "string" == typeof (s2 = i2) && (s2 = S(s2)), (s2 ? (299 * s2.r + 587 * s2.g + 114 * s2.b) / 1e3 : null) < 128 ? "has-dark-background" : "has-light-background";
    }
    var s2;
    return null;
  }
...
var k = class {
  ...
  autoAnimateElements(e2, t2, i2, s2, a2) {
    ...
    if (t2.classList.contains("fragment") && (delete o2.styles.opacity, e2.classList.contains("fragment"))) {
      (e2.className.match(b) || [""])[0] === (t2.className.match(b) || [""])[0] && "forward" === s2.slideDirection && t2.classList.add("visible", "disabled");
    }
...
var L = class {
  ...
  activate() {
    ...
    const i2 = t(this.Reveal.getRevealElement(), m);
    let s2;
...
var C = class {
  ...
  async activate() {
    const e2 = this.Reveal.getConfig(), i2 = t(this.Reveal.getRevealElement(), v), s2 = e2.slideNumber && /all|print/i.test(e2.showSlideNumber), a2 = this.Reveal.getComputedSlideSize(window.innerWidth, window.innerHeight), n2 = Math.floor(a2.width * (1 + e2.margin)), r2 = Math.floor(a2.height * (1 + e2.margin)), l2 = a2.width, d2 = a2.height;
    ...
    i2.forEach(function(i3, a3) {
      if (false === i3.classList.contains("stack")) {
        ...
        const p3 = u2[a3];
        let v2 = Math.max(Math.ceil(p3 / r2), 1);
        v2 = Math.min(v2, e2.pdfMaxPagesPerSlide), (1 === v2 && e2.center || i3.classList.contains("center")) && (c3 = Math.max((r2 - p3) / 2, 0));
        const f2 = document.createElement("div");
        if (g2.push(f2), f2.className = "pdf-page", f2.style.height = (r2 + e2.pdfPageHeightOffset) * v2 + "px", h2 && (f2.style.background = h2), f2.appendChild(i3), i3.style.left = o2 + "px", i3.style.top = c3 + "px", i3.style.width = l2 + "px", this.Reveal.slideContent.layout(i3), i3.slideBackgroundElement && f2.insertBefore(i3.slideBackgroundElement, i3), e2.showNotes) {
        ...
        if (s2) {
          ...
          e3.classList.add("slide-number"), e3.classList.add("slide-number-pdf"), e3.innerHTML = m2++, f2.appendChild(e3);
        }
...
var P = class {
  ...
  activate() {
    if (this.Reveal.getConfig().overview && !this.Reveal.isScrollView() && !this.isActive()) {
      this.active = true, this.Reveal.getRevealElement().classList.add("overview"), this.Reveal.cancelAutoSlide(), this.Reveal.getSlidesElement().appendChild(this.Reveal.getBackgroundsElement()), t(this.Reveal.getRevealElement(), v).forEach((e3) => {
  ...
  deactivate() {
    if (this.Reveal.getConfig().overview) {
      ...
      }, 1), this.Reveal.getRevealElement().appendChild(this.Reveal.getBackgroundsElement()), t(this.Reveal.getRevealElement(), v).forEach((e3) => {
...
var T = class {
  ...
  onDocumentKeyDown(e2) {
    ...
    false === h2 && (h2 = true, 80 === i2 || 33 === i2 ? this.Reveal.prev({ skipFragments: e2.altKey }) : 78 === i2 || 34 === i2 ? this.Reveal.next({ skipFragments: e2.altKey }) : 72 === i2 || 37 === i2 ? e2.shiftKey ? this.Reveal.slide(0) : !this.Reveal.overview.isActive() && c2 ? this.Reveal.prev({ skipFragments: e2.altKey }) : this.Reveal.left({ skipFragments: e2.altKey }) : 76 === i2 || 39 === i2 ? e2.shiftKey ? this.Reveal.slide(this.Reveal.getHorizontalSlides().length - 1) : !this.Reveal.overview.isActive() && c2 ? this.Reveal.next({ skipFragments: e2.altKey }) : this.Reveal.right({ skipFragments: e2.altKey }) : 75 === i2 || 38 === i2 ? e2.shiftKey ? this.Reveal.slide(void 0, 0) : !this.Reveal.overview.isActive() && c2 ? this.Reveal.prev({ skipFragments: e2.altKey }) : this.Reveal.up({ skipFragments: e2.altKey }) : 74 === i2 || 40 === i2 ? e2.shiftKey ? this.Reveal.slide(void 0, Number.MAX_VALUE) : !this.Reveal.overview.isActive() && c2 ? this.Reveal.next({ skipFragments: e2.altKey }) : this.Reveal.down({ skipFragments: e2.altKey }) : 36 === i2 ? this.Reveal.slide(0) : 35 === i2 ? this.Reveal.slide(this.Reveal.getHorizontalSlides().length - 1) : 32 === i2 ? (this.Reveal.overview.isActive() && this.Reveal.overview.deactivate(), e2.shiftKey ? this.Reveal.prev({ skipFragments: e2.altKey }) : this.Reveal.next({ skipFragments: e2.altKey })) : [58, 59, 66, 86, 190].includes(i2) || 191 === i2 && !e2.shiftKey ? this.Reveal.togglePause() : 70 === i2 ? ((e3) => {
      ...
      t3 && t3.apply(e3);
    })(t2.embedded ? this.Reveal.getViewportElement() : document.documentElement) : 65 === i2 ? t2.autoSlideStoppable && this.Reveal.toggleAutoSlide(s2) : 71 === i2 ? t2.jumpToSlide && this.Reveal.toggleJumpToSlide() : 191 === i2 && e2.shiftKey ? this.Reveal.toggleHelp() : h2 = false), h2 ? e2.preventDefault && e2.preventDefault() : 27 !== i2 && 79 !== i2 || (false === this.Reveal.closeOverlay() && this.Reveal.overview.toggle(), e2.preventDefault && e2.preventDefault()), this.Reveal.cueAutoSlide();
  }
};
var N = class {
  constructor(e2) {
...
function K(n2, o2) {
  ...
  function fe() {
    H2 = true, R2.showHiddenSlides || t(X2.wrapper, 'section[data-visibility="hidden"]').forEach((e2) => {
      ...
      X2.slides.classList.remove("no-transition"), X2.wrapper.classList.add("ready"), Le({ type: "ready", data: { indexh: c2, indexv: u2, currentSlide: b2 } });
    }, 1);
  }
  function ye(e2) {
  ...
  function Ce(e2) {
    Le({ type: "slidechanged", data: { indexh: c2, indexv: u2, previousSlide: g2, currentSlide: b2, origin: e2 } });
  }
  function xe(t2, i2) {
  ...
  function Be() {
    if (X2.wrapper && !ne.isActive()) {
      ...
      if (!R2.disableLayout) {
        ...
        const a2 = Array.from(X2.wrapper.querySelectorAll(v));
        ...
        s2 !== K2 && Le({ type: "resize", data: { oldScale: s2, scale: K2, size: i2 } });
      }
      !function() {
        if (X2.wrapper && !R2.disableLayout && !ne.isActive() && "number" == typeof R2.scrollActivationWidth && "scroll" !== R2.view) {
          const e3 = De();
          e3.presentationWidth > 0 && e3.presentationWidth <= R2.scrollActivationWidth ? ae.isActive() || (se.create(), ae.activate()) : ae.isActive() && ae.deactivate();
        }
  ...
  function Oe() {
    return !(!b2 || !qe(b2)) && !b2.nextElementSibling;
  }
  function We() {
    return 0 === c2 && 0 === u2;
  }
  function Ue() {
    return !!b2 && (!b2.nextElementSibling && (!qe(b2) || !b2.parentNode.nextElementSibling));
  }
  function Ve() {
    if (R2.pause) {
  ...
  function Xe(e2, i2, s2, a2) {
    if (Le({ type: "beforeslidechange", data: { indexh: void 0 === e2 ? c2 : e2, indexv: void 0 === i2 ? u2 : i2, origin: a2 } }).defaultPrevented)
      return;
    g2 = b2;
    const n3 = X2.wrapper.querySelectorAll(m);
    if (ae.isActive()) {
    ...
    q2.length = 0;
    let o3 = c2 || 0, l2 = u2 || 0;
    c2 = Ge(m, void 0 === e2 ? c2 : e2), u2 = Ge(f, void 0 === i2 ? u2 : i2);
    let d3 = c2 !== o3 || u2 !== l2;
    d3 || (g2 = null);
    let h2 = n3[c2], p2 = h2.querySelectorAll("section");
    b2 = p2[u2] || h2;
    let v2 = false;
    d3 && g2 && b2 && !oe.isActive() && (Y = "running", v2 = Ye(g2, b2, o3, l2), v2 && X2.slides.classList.add("disable-slide-transitions")), et(), Be(), oe.isActive() && oe.update(), void 0 !== s2 && re.goto(s2), g2 && g2 !== b2 && (g2.classList.remove("present"), g2.setAttribute("aria-hidden", "true"), We() && setTimeout(() => {
      t(X2.wrapper, m + ".stack").forEach((e3) => {
        Fe(e3, 0);
      });
    }, 0));
    e:
    ...
    d3 && Ce(a2), !d3 && g2 || (Z.stopEmbeddedContent(g2), Z.startEmbeddedContent(b2)), requestAnimationFrame(() => {
      ye(be(b2));
  ...
  function tt({ includeFragments: e2 = false } = {}) {
    let t2 = X2.wrapper.querySelectorAll(m), i2 = X2.wrapper.querySelectorAll(f), s2 = { left: c2 > 0, right: c2 < t2.length - 1, up: u2 > 0, down: u2 < i2.length - 1 };
  ...
  function st(e2) {
    ...
    if (!e2 && b2) {
      if (b2.querySelectorAll(".fragment").length > 0) {
        let e3 = b2.querySelector(".current-fragment");
        i2 = e3 && e3.hasAttribute("data-fragment-index") ? parseInt(e3.getAttribute("data-fragment-index"), 10) : b2.querySelectorAll(".fragment.visible").length - 1;
      }
    }
    return { h: s2, v: a2, f: i2 };
  }
  function at() {
    return t(X2.wrapper, v + ':not(.stack):not([data-visibility="uncounted"])');
  }
  function nt() {
    return t(X2.wrapper, m);
  }
  function rt() {
  ...
  function ut() {
    if (gt(), b2 && false !== R2.autoSlide) {
      let e2 = b2.querySelector(".current-fragment[data-autoslide]"), i2 = e2 ? e2.getAttribute("data-autoslide") : null, s2 = b2.parentNode ? b2.parentNode.getAttribute("data-autoslide") : null, a2 = b2.getAttribute("data-autoslide");
      i2 ? _ = parseInt(i2, 10) : a2 ? _ = parseInt(a2, 10) : s2 ? _ = parseInt(s2, 10) : (_ = R2.autoSlide, 0 === b2.querySelectorAll(".fragment").length && t(b2, "video, audio").forEach((e3) => {
      ...
      }, _), G = Date.now()), S2 && S2.setPlaying(-1 !== J);
    }
  }
  function gt() {
    clearTimeout(J), J = -1;
  ...
  function pt() {
    _ && !Q && (Q = true, Le({ type: "autoslidepaused" }), clearTimeout(J), S2 && S2.setPlaying(false));
  }
  function vt() {
  ...
  function wt({ skipFragments: e2 = false } = {}) {
    if (e2 || false === re.prev())
      if (tt().up)
        ...
        let i2;
        if (i2 = R2.rtl ? t(X2.wrapper, m + ".future").pop() : t(X2.wrapper, m + ".past").pop(), i2 && i2.classList.contains("stack")) {
  ...
  function At(e2) {
    "running" === Y && /section/gi.test(e2.target.nodeName) && (Y = "idle", Le({ type: "slidetransitionend", data: { indexh: c2, indexv: u2, previousSlide: g2, currentSlide: b2 } }));
  }
  function Rt(e2) {
  ...
  const Tt = { VERSION: j, initialize: function(e2) {
    ...
    let e2 = dt(), t2 = it();
    if (b2) {
      let e3 = b2.querySelectorAll(".fragment");
      if (e3.length > 0) {
        let i2 = 0.9;
        t2 += b2.querySelectorAll(".fragment.visible").length / e3.length * i2;
      }
    }
  ...
  }, getSlidePastCount: it, getTotalSlides: dt, getSlide: ct, getPreviousSlide: () => g2, getCurrentSlide: () => b2, getSlideBackground: function(e2, t2) {
    ...
    c2 = t2, u2 = i2;
    const a2 = b2 !== e2;
    g2 = b2, b2 = e2, b2 && g2 && R2.autoAnimate && Ye(g2, b2, s2, u2) && ie.run(g2, b2), a2 && (g2 && (Z.stopEmbeddedContent(g2), Z.stopEmbeddedContent(g2.slideBackgroundElement)), Z.startEmbeddedContent(b2), Z.startEmbeddedContent(b2.slideBackgroundElement)), requestAnimationFrame(() => {
      ye(be(b2));
    }), Ce();
